...
CONFIGURATION = --enable-fbdev --host-cc=gcc --target=arm-none-linux --cc=arm-none-linux-gnueabi-gcc --as=arm-none-linux-gnueabi-as --ar=arm-none-linux-gnueabi-ar --ranlib=arm-none-linux-gnueabi-ranlib --enable-static --disable-dvdnav --disable-dvdread-internal --disable-libdvdcss-internal --enable-armv6
...
CFLAGS   = -Wstrict-prototypes -Wmissing-prototypes -Wundef -Wdisabled-optimization -Wno-pointer-sign -Wdeclaration-after-statement -std=gnu99 -Wall -Wno-switch -Wno-parentheses -Wpointer-arith -Wredundant-decls -O4   -pipe -ffast-math -fomit-frame-pointer -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -I.   
ASFLAGS  = $(CFLAGS)
...
EXTRALIBS          = -Wl,-z,noexecstack  -ffast-math   -lpthread -ldl -rdynamic -static -lm 
EXTRALIBS_MPLAYER  = 
EXTRALIBS_MENCODER = 
